...
exports.UserController = exports.CredentialsRequestBody = exports.CredentialsSchema = exports.NewUserRequest = void 0;
...
let UserController = class UserController {
    constructor(
    //Inject JWT, User Repository
    jwtService, userService, user, userRepository) {
...
tslib_1.__decorate([
    ...
    tslib_1.__param(0, (0, rest_1.requestBody)({
        content: {
            'application/json': {
                schema: (0, rest_1.getModelSchemaRef)(NewUserRequest, { title: 'NewUser' }),
            },
        },
    })),
    tslib_1.__metadata("design:type", Function),
